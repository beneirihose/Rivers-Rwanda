          ...
          >
            ...
            <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-sm border border-gray-100">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                {[ { icon: <Fuel />, label: 'Fuel Type', value: car.fuel_type }, { icon: <Settings />, label: 'Transmission', value: car.transmission }, { icon: <Users />, label: 'Capacity', value: `${car.seating_capacity} Seats` }, { icon: <Gauge />, label: 'Type', value: car.vehicle_type }, ].map((spec, i) => (
                  <div key={i} className="space-y-2">
                    ...
                    <p className="font-bold text-primary-dark uppercase text-sm capitalize">{spec.value}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="prose prose-slate max-w-none">
                ...
                <p className="text-text-light leading-relaxed font-medium">{car.description || `Experience the ultimate in comfort and reliability with this premium ${car.make} ${car.model}. Perfect for business trips or exploring the scenic beauty of Rwanda.`}</p>
              </div>
            </div>
          </motion.div>
